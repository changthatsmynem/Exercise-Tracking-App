...
//         <label htmlFor="start-time" className="form-field label">
//           Start Time:
//         </label>
//         <input
//           type="time"
...
//       </div>
//       <div className="form-field">
//         <label htmlFor="end-time" className="form-field label">
//           End Time:
//         </label>
//         <input
//           type="time"
...
//       </div>
//       <div className="form-field">
//         <label htmlFor="picture" className="form-field label">
//           Picture:
//         </label>
//         <input
//           type="file"
...
//       </div>
//       <div className="form-field">
//         <label htmlFor="distance" className="form-field label">
//           Distance (km):
//         </label>
//         <input
//           type="number"
...
//       <form onSubmit={handleTrackerSubmit} className="form-container">
//         <ExerciseForm />
//         <ActivityForm />
